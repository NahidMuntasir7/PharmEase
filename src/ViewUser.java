...
public class ViewUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 190, 920, 400));

        jLabel2.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        jLabel2.setText("Click on row to delete user");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(343, 459, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/wallpaper_1648780033c32326e0b0f7777f7a0d71dc8d49f205.jpeg"))); // NOI18N
        ...
        if(username.equals(usernameTable)){
            ...
            if(a == 0){
                try{
                    ...
                    ps.setString(1, id);
                    ps.executeUpdate();
                    JOptionPane.showMessageDialog(null, "User succcessfully deleted");
                    setVisible(false);
